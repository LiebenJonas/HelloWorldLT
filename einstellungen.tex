...
%% des Dokuments.
\setzematrikelnr{8761357}
\setzekurs{TINFXX}
\setzetitel{Aufsetzen eines NodeMCU8266 zum Auslesen sensorspezifischer Daten}
\setzedatumAbgabe{September 2024}
\setzefirma{Mercedes-Benz AG}
\setzefirmenort{Stuttgart}
\setzeabgabeort{Stuttgart}
\setzeabschluss{Prüfung zum Bachelor of Science}
\setzestudiengang{IT-Automotive}
\setzedhbw{Stuttgart}
\setzebetreuer{Betreuer}
\setzegutachter{}
\setzezeitraum{01.10.2024 - 15.12.2024} % Hier kann man auch z.B. 12 Wochen als Zeitraum angeben
\setzearbeit{Hello World}
\setzeautor{Jonas Lieben}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
